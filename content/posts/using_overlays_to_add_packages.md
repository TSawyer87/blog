+++
date = '2025-05-14T19:28:57-04:00'
draft = false
title = 'Using_overlays_to_add_packages'
author = "T Sawyer"
+++

# Using Overlays to add Packages that aren't in Nixpkgs

{{< figure src="images/pokego.png" alt="window_view" width="1000" >}}
...
- It may be helpful to first read my
  [NixFlakesTips](https://saylesss88.github.io/posts/nix_flakes_tips/)
...
[PackageDefinition](https://saylesss88.github.io/posts/understanding_package_definitions/)
