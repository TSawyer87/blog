+++
date = '2025-05-16T19:54:01-04:00'
draft = false
title = 'Using_nushell_with_nixos'
+++

## Nushell and NixOS

{{< figure src="/images/nu.png" alt="nushell logo" width="1000" >}}
...
{{< figure src="/images/explore.png" alt="explore command" width="80%" >}}
...
- `Ctrl+t` List Commands with carapace and fzf:
  ...
  {{< figure src="/images/nu4.png" alt="atuin" width="80%" >}}
...
- `Carapace` man example:
  ...
  {{< figure src="/images/nu7.png" alt="carapace_man" width="80%" >}}
...
{{< figure src="/images/nu5.png" alt="carapace" width="80%" >}}
...
{{< figure src="/images/nu10.png" alt="nix search" width="80%" >}}
...
{{< figure src="/images/nu1.png" alt="nufetch" width="80%" >}}

- `duf` command, I have mine aliased to `df`:

{{< figure src="/images/nu8.png" alt="duff" width="80%" >}}

- `ps` command:

{{< figure src="/images/ps.png" alt="ps" width="80%" >}}
...
{{< figure src="/images/config1.png" alt="Diff" width="80%" >}}
...
{{< figure src="/images/nu6.png" alt="obsidian" width="80%" >}}
...
{{< figure src="/images/just2.png" alt="just" width="80%" >}}
